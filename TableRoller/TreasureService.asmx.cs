...
namespace TableRoller
{
	...
	public class TreasureService : System.Web.Services.WebService
	{
		...
		RollableList GetADnDTreasureTypes()
		{
            ...
            // ******  TODO: Write this out to TreasureTypes.xml; currently only has A and B; the parse methods might not be able to all the syntax yet.
			// ******  TODO: Die roll strings consisting of only a constant N should parse to 0d0+N
            ...
            // TODO: the "d1" in this ItemRoll means perform the TableRoll exactly once; 
            //  is wrapping a TableRoll in an ItemRoll necessary if the TableRoll is only to be done 1x? 
